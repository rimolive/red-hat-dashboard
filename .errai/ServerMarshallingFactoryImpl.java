...
public class ServerMarshallingFactoryImpl implements MarshallerFactory {
  ...
  private Marshaller<GraphData> org_jboss_tools_gwt_kitchensink_client_shared_GraphData;
  ...
  public ServerMarshallingFactoryImpl() {
    ...
    org_jboss_tools_gwt_kitchensink_client_shared_GraphData = new Marshaller<GraphData>() {
      public Class getTypeHandled() {
        return GraphData.class;
      }
      public GraphData demarshall(EJValue a0, MarshallingSession a1) {
        try {
          if (a0.isNull()) {
            return null;
          }
          ...
          String objId = obj.get("^ObjectID").isString().stringValue();
          if (a1.hasObjectHash(objId)) {
            return a1.getObject(GraphData.class, objId);
          }
          GraphData entity = new GraphData();
          a1.recordObjectHash(objId, entity);
          if ((obj.containsKey("columnData")) && (!obj.get("columnData").isNull())) {
            entity.setColumnData(java_util_Map.demarshall(obj.get("columnData"), a1));
          }
          if ((obj.containsKey("pieData")) && (!obj.get("pieData").isNull())) {
            entity.setPieData(java_util_Map.demarshall(obj.get("pieData"), a1));
          }
          if ((obj.containsKey("gaugeData")) && (!obj.get("gaugeData").isNull())) {
            entity.setGaugeData(java_lang_Integer.demarshall(obj.get("gaugeData"), a1));
          }
          return entity;
        } catch (Throwable t) {
          t.printStackTrace();
          throw new RuntimeException("error demarshalling entity: org.jboss.tools.gwt.kitchensink.client.shared.GraphData", t);
        }
      }
      public String marshall(GraphData a0, MarshallingSession a1) {
        if (a0 == null) {
          return "null";
        }
        if (a1.hasObjectHash(a0)) {
          String objId = a1.getObjectHash(a0);
          return new StringBuilder(128).append("{\"^EncodedType\":\"org.jboss.tools.gwt.kitchensink.client.shared.GraphData\"").append(",").append("\"^ObjectID\":\"").append(objId).append("\"}").toString();
        }
        String objId = a1.getObjectHash(a0);
        a1.recordObjectHash(objId, objId);
        return new StringBuilder(512).append("{\"^EncodedType\":\"org.jboss.tools.gwt.kitchensink.client.shared.GraphData\",\"^ObjectID\":\"").append(objId).append("\"").append(",").append("\"columnData\" : ").append(java_util_Map.marshall(a0.getColumnData(), a1)).append(",").append("\"pieData\" : ").append(java_util_Map.marshall(a0.getPieData(), a1)).append(",").append("\"gaugeData\" : ").append(java_lang_Integer.marshall(a0.getGaugeData(), a1)).append("}").toString();
      }
    };
    marshallers.put("org.jboss.tools.gwt.kitchensink.client.shared.GraphData", org_jboss_tools_gwt_kitchensink_client_shared_GraphData);
